...
$mat=$_GET['mat'];
$pdostat= $objetpdo->prepare("SELECT *FROM services where ids='$mat'");
$v=$pdostat->execute();
$par=$pdostat->fetch();
...
$modif=$objetpdo->prepare ("UPDATE services SET nom_service='$nom' where (ids='$mat')" );
$v=$modif->execute();
if ($v==true) {
    	echo "<script>
...
<center><p><a href="seraff.php"></a></p>
    <h1 style="color:red;">modifier SERVICE</h1>
<form action="" method="POST">
  <label>Nom</label><br>
  <input type="text" name="noms" value= <?=$par['nom_service']?>>
        <br>
